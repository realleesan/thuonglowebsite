...
echo "<h1>Process Commission for Order $orderId</h1>";
...
try {
    ...
    if ($order['commission_amount'] > 0) {
        echo "Order already has commission: " . number_format($order['commission_amount']) . " VND";
        exit;
    }
    ...
    echo "<a href='check_order2.php'>Check other orders</a> | <a href='?page=affiliate'>Check Affiliate Page</a>";
