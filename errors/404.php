    ...
    <div class="error-content">
        ...
        <div class="error-suggestions">
            ...
            <ul>
                ...
                <li>Quay về <a href="<?php echo nav_url('home'); ?>">trang chủ</a></li>
                <li>Xem <a href="<?php echo nav_url('products'); ?>">sản phẩm</a> của chúng tôi</li>
                <li>Đọc <a href="<?php echo nav_url('news'); ?>">tin tức</a> mới nhất</li>
                <li><a href="<?php echo nav_url('contact'); ?>">Liên hệ</a> với chúng tôi nếu cần hỗ trợ</li>
            </ul>
        </div>
