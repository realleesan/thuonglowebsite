...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    if (mobileMenuToggle && mobileNavDrawer && mobileDrawerOverlay) {
        ...
        // Submenu Toggle on Mobile Drawer (Accordion style)
        const submenuToggles = mobileNavDrawer.querySelectorAll('.drawer-submenu-toggle');
