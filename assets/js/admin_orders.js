...
function initOrdersIndex() {
    ...
    if (confirmDeleteBtn) {
        confirmDeleteBtn.addEventListener('click', function() {
            ...
            setTimeout(() => {
                ...
                // In real app, reload page or remove row
            }, 1500);
        });
    }
    ...
    if (confirmBulkUpdateBtn) {
        confirmBulkUpdateBtn.addEventListener('click', function() {
            ...
            showToast(`Đang cập nhật ${checkedOrders.length} đơn hàng...`, 'info');
            setTimeout(() => {
                showToast('Cập nhật trạng thái thành công!', 'success');
                hideModal('bulkUpdateModal');
                // In real app, update the status badges
            }, 2000);
        });
    }
}
    ...
    if (confirmDeleteBtn) {
        confirmDeleteBtn.addEventListener('click', function() {
            ...
            setTimeout(() => {
                ...
                window.location.href = '?page=admin&module=orders';
            }, 1500);
        });
    }
}
