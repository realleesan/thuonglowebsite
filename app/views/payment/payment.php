...
// Payment configuration - lấy từ config nếu có
$bankAcc = $config['sepay']['account_number'] ?? "0914960029666";
$bankName = $config['sepay']['bank_code'] ?? "MBBank";
$bankOwner = $config['sepay']['account_name'] ?? "LE VU BAO NHAT";
    ...
    <div class="container">
        ...
        <div class="qr-container">
            ...
            <div class="order-info">
                ...
                <p><strong>Chủ tài khoản:</strong> <?php echo htmlspecialchars($bankOwner); ?></p>
