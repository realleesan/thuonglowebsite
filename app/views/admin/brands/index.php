        ...
        <div class="pagination-container">
            <div class="pagination">
                <?php if ($current_page > 1): ?>
                    <a href="?page=admin&module=brands&<?= http_build_query(array_merge($_GET, ['page' => $current_page - 1])) ?>" 
                ...
                if ($start_page > 1): ?>
                    <a href="?page=admin&module=brands&<?= http_build_query(array_merge($_GET, ['page' => 1])) ?>" 
                ...
                <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                    <a href="?page=admin&module=brands&<?= http_build_query(array_merge($_GET, ['page' => $i])) ?>" 
                ...
                <?php if ($end_page < $total_pages): ?>
                    <?php if ($end_page < $total_pages - 1): ?>
                        <span class="pagination-dots">...</span>
                    <?php endif; ?>
                    <a href="?page=admin&module=brands&<?= http_build_query(array_merge($_GET, ['page' => $total_pages])) ?>" 
