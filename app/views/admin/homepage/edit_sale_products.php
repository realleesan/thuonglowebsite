    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1">Chỉnh sửa Section Sản phẩm Giảm giá</h4>
                    <p class="text-muted mb-0">Cấu hình tiêu đề và trạng thái hiển thị section sản phẩm giảm giá</p>
                </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form id="saleProductsForm" method="POST" action="?page=admin&module=homepage&action=update-sale-products">
                            ...
                            <div class="col-md-8">
                                <div class="mb-4">
                                    <label for="title" class="form-label fw-semibold">
                                        <i class="fas fa-heading text-danger me-2"></i>Tiêu đề Section
                                    </label>
                                    ...
                                    <div class="form-text">
                                        <small class="text-muted">
                                            ...
                                            <code>&lt;h2&gt;Sản phẩm &lt;span class="highlight"&gt;Giảm giá&lt;/span&gt;&lt;/h2&gt;</code>
                                        </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="border-top pt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <button type="button" class="btn btn-outline-danger me-2" onclick="previewTitle()">
...
document.getElementById('saleProductsForm').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    fetch('?page=admin&module=homepage&action=update-sale-products', {
        method: 'POST',
        body: formData
    })
