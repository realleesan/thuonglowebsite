<?php
/**
 * Edit Featured Categories Section View - Enhanced Custom Editor
 */

// Ensure section data is available
if (!isset($featuredCategoriesSection)) {
    $featuredCategoriesSection = [];
}

// Set default values
$featuredCategoriesSection = array_merge([
    'id' => 0,
...
<div class="hero-section-page hero-section-edit-page">
    ...
    <div class="page-header">
        <div class="page-header-left">
            <h1 class="page-title">
                ...
                Chỉnh sửa Section Danh mục Nổi bật
            </h1>
            <p class="page-description">Tùy chỉnh tiêu đề và hiển thị section danh mục nổi bật trên trang chủ.</p>
        </div>
    ...
    <div class="admin-form-full">
        <div class="admin-card">
            <form id="featuredCategoriesForm" method="POST">
                <input type="hidden" name="id" value="<?php echo $featuredCategoriesSection['id']; ?>">
                ...
                <div class="form-group mb-4">
                    ...
                    <div id="editor-title" class="custom-editable-area" contenteditable="true" oninput="syncEditor('title')">
                        <?php echo $featuredCategoriesSection['title']; ?>
                    </div>
                    <textarea id="title" name="title" style="display:none;"><?php echo htmlspecialchars($featuredCategoriesSection['title']); ?></textarea>
                </div>

                <div class="form-check mb-4">
                    <input type="checkbox" id="is_active" name="is_active" value="1" <?php echo ($featuredCategoriesSection['is_active'] ? 'checked' : ''); ?>>
...
// Form Submit
document.getElementById('featuredCategoriesForm').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    fetch('?page=admin&module=homepage&action=update-featured-categories', {
        method: 'POST',
        body: formData,
        headers: {
    ...
    .then(d => {
        ...
        if (d.success) {
            alert('Đã cập nhật Section Danh mục Nổi bật thành công!');
