<!-- Main Content -->
<div id="wrapper-container" class="wrapper-container about-page">
    <div class="content-pusher">
        <div id="main-content">
            <div class="elementor elementor-about">
                <!-- Breadcrumb -->
                        ...
                        <div class="cta-container">
                            ...
                            <div class="cta-features">
                                <div class="cta-feature">
                                    ...
                                    <h4>Uy tín</h4>
                                    <p>Chúng tôi luôn tìm giải pháp tối ưu chứ không chỉ là dễ dàng.</p>
                                </div>
                                <div class="cta-feature">
                                    <div class="cta-feature-icon">
                                        <svg width="80" height="80" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h4>Hoa hồng</h4>
                                    <p>Chúng tôi luôn nỗ lực để mang lại giá trị vượt mong đợi cho đối tác.</p>
                                </div>
                                <div class="cta-feature">
                                    <div class="cta-feature-icon">
                                        <svg width="80" height="80" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h4>Hợp tác</h4>
                                    <p>Chúng tôi luôn đặt lợi ích của khách hàng và đối tác lên hàng đầu.</p>
                                </div>
                                <div class="cta-feature">
                                    <div class="cta-feature-icon">
                                        <svg width="80" height="80" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h4>Minh bạch</h4>
                                    <p>Chính sách rõ ràng, dữ liệu minh bạch, phối hợp dài lâu.</p>
                                </div>
                            </div>
...
<div id="agentModal" class="modal" role="dialog" aria-modal="true" aria-labelledby="agentModalTitle" aria-hidden="true">
    <div class="modal-content">
        <div class="modal-header">
            <button class="close" type="button" aria-label="Đóng" onclick="closeModal()">&times;</button>
