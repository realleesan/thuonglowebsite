...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($phone) || empty($password)) {
        ...
        if (mockLogin($phone, $password, $role)) {
            ...
            $success = 'ÄÄƒng nháº­p thÃ nh cÃ´ng!';
        } else {
            $error = 'ÄÄƒng nháº­p tháº¥t báº¡i';
        }
    }
}
    ...
    <section class="auth-section login-page">
        <div class="container">
            ...
            <div class="auth-panel">
                <h2 class="auth-heading">ÄÄƒng nháº­p</h2>
                ...
                <?php if ($success): ?>
                    <div class="alert alert-success"><?php echo $success; ?> Äang chuyá»ƒn hÆ°á»›ng...</div>
                    <script>
                        setTimeout(function() {
                ...
                <form method="POST" action="<?php echo form_url(); ?>" class="auth-form">
                    <div class="form-group">
                        <label for="phone" class="form-label">TÃªn Ä‘Äƒng nháº­p hoáº·c email</label>
                    ...
                    <div class="remember-forgot">
                        ...
                        <div class="register-link" style="margin-top: 15px; margin-bottom: 10px;">
                            <a href="<?php echo page_url('forgot', ['reset' => 'true']); ?>">QuÃªn máº­t kháº©u?</a>
                        </div>
                    </div>

                    <button type="submit" class="btn-primary auth-submit-btn">ÄÄƒng nháº­p</button>
                ...
                <div class="role-demo">
                    <div class="role-demo-text">Báº¡n lÃ ?</div>
                    <button type="button" class="demo-toggle" onclick="toggleRoleSelector()">
                        Nháº¥n Ä‘á»ƒ truy cáº­p vá»›i vai trÃ²:
                    </button>
                    ...
                    <div class="role-selector hidden" id="role-selector">
                        <div class="role-options">
                            <div class="role-option <?php echo $rememberedRole === 'user' ? 'active' : ''; ?>" onclick="selectRole('user')">
                                ...
                                <label for="role_user">KhÃ¡ch hÃ ng</label>
                            </div>
                            <div class="role-option <?php echo $rememberedRole === 'agent' ? 'active' : ''; ?>" onclick="selectRole('agent')">
                                ...
                                <label for="role_agent">Äáº¡i lÃ½</label>
                            </div>
                            <div class="role-option <?php echo $rememberedRole === 'admin' ? 'active' : ''; ?>" onclick="selectRole('admin')">
                                ...
                                <label for="role_admin">Quáº£n trá»‹</label>
                            </div>
                        </div>
                    </div>
                </div>
