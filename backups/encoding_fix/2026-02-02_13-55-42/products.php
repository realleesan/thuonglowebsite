                        ...
                        <div class="products-layout">
                            ...
                            <div class="products-main">
                                ...
                                <div class="products-header">
                                    <h1 class="page-title">Sáº£n pháº©m</h1>
                                ...
                                <div class="products-topbar">
                                    <div class="results-count">
                                        <span>Hiá»ƒn thá»‹ 1-12 trong tá»•ng sá»‘ 20 káº¿t quáº£</span>
                                    </div>
                                    <div class="sort-dropdown">
                                        <form method="get">
                                            <select name="order_by" class="sort-select">
                                                <option value="post_date" selected>Má»›i nháº¥t</option>
                                                <option value="post_title">TÃªn A-Z</option>
                                                <option value="post_title_desc">TÃªn Z-A</option>
                                                <option value="price">GiÃ¡ cao Ä‘áº¿n tháº¥p</option>
                                                <option value="price_low">GiÃ¡ tháº¥p Ä‘áº¿n cao</option>
                                                <option value="popular">Phá»• biáº¿n</option>
                                                <option value="rating">ÄÃ¡nh giÃ¡ trung bÃ¬nh</option>
                                            </select>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="products-grid">
                                    ...
                                    <div class="course-item">
                                        <div class="course-category">
                                            <a href="#" class="category-tag">Data nguá»“n hÃ ng</a>
                                        </div>
                                        <div class="course-image">
                                            <a href="?page=details">
                                                <img src="https://eduma.thimpress.com/demo-marketplace/wp-content/uploads/sites/99/2024/10/course-offline-01-675x450.jpg" alt="Data nguá»“n hÃ ng cháº¥t lÆ°á»£ng" loading="lazy">
                                            </a>
                                        </div>
                                        <div class="course-content">
                                            <h4 class="course-title">
                                                <a href="?page=details">Data nguá»“n hÃ ng cháº¥t lÆ°á»£ng cao</a>
                                            </h4>
                                            <div class="course-excerpt">Cung cáº¥p database nhÃ  cung cáº¥p uy tÃ­n, thÃ´ng tin sáº£n pháº©m chi tiáº¿t vÃ  giÃ¡ cáº£ cáº¡nh tranh tá»« cÃ¡c thá»‹ trÆ°á»ng lá»›n nhÆ° Trung Quá»‘c, ThÃ¡i Lan, Malaysia...</div>
                                            ...
                                            <div class="course-meta">
                                                <div class="course-lessons">
                                                    ...
                                                    <span>1000+ NhÃ  cung cáº¥p</span>
                                                </div>
                                            </div>
                                            <div class="course-price">
                                                <span class="price">2.500.000Ä‘</span>
                                            </div>
                            ...
                            <div class="products-sidebar" id="productsSidebar">
                                ...
                                <div class="sidebar-content">
                                    ...
                                    <div class="filter-section">
                                        <h3 class="filter-title">Danh má»¥c</h3>
                                        <div class="filter-content">
                                            <ul class="category-list">
                                                <li><a href="#">TÃ¬m kiáº¿m nhiá»u nháº¥t</a> <span class="count">(14)</span></li>
                                                <li><a href="#">GÃ³i Data Nguá»“n HÃ ng</a> <span class="count">(8)</span></li>
                                                <li><a href="#">Váº­n Chuyá»ƒn</a> <span class="count">(6)</span></li>
                                                <li><a href="#">Mua HÃ ng Trá»n GÃ³i</a> <span class="count">(4)</span></li>
                                                <li><a href="#">Thanh ToÃ¡n Quá»‘c Táº¿</a> <span class="count">(3)</span></li>
                                                <li><a href="#">ÄÃ¡nh HÃ ng</a> <span class="count">(2)</span></li>
                                                <li><a href="#">Sáº£n Pháº©m KhÃ¡c</a> <span class="count">(5)</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Reset Button -->
                                    <div class="filter-section">
                                        <button class="reset-filters-btn">Äáº·t láº¡i</button>
                                    </div>

                                    <!-- Author Filter -->
                                    <div class="filter-section">
                                        <h3 class="filter-title">NhÃ  cung cáº¥p</h3>
                                        <div class="filter-content">
                                    ...
                                    <!-- Price Filter -->
                                    <div class="filter-section">
                                        <h3 class="filter-title">GiÃ¡</h3>
                                        <div class="filter-content">
                                            <ul class="price-list">
                                                <li><a href="#">Miá»…n phÃ­</a></li>
                                                <li><a href="#">CÃ³ phÃ­</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Apply Button -->
                                    <div class="filter-section">
                                        <button class="apply-filters-btn">Ãp dá»¥ng</button>
                                    </div>
                                </div>
                            </div>
                        </div>
