    ...
    <div class="content-pusher">
        <div id="main-content">
            <div class="elementor elementor-87">
                <?php 
                // Breadcrumb sáº½ Ä‘Æ°á»£c hiá»ƒn thá»‹ tá»« master layout
                ?>
                    ...
                    <section class="hero-section">
                        ...
                        <div class="container">
                            <div class="hero-content">
                                <h1 class="hero-title">ChÃºng tÃ´i cÃ³ thá»ƒ giÃºp gÃ¬ cho báº¡n?</h1>
                                <p class="hero-subtitle">Äá»™i ngÅ© ThuongLo sáºµn sÃ ng há»— trá»£ vÃ  tÆ° váº¥n má»i tháº¯c máº¯c cá»§a báº¡n.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="contact-form-section">
                        <div class="container">
                            <div class="section-header">
                                <h2 class="section-title">Äiá»n thÃ´ng tin liÃªn há»‡</h2>
                                <p class="section-subtitle">Ä‘á»ƒ chÃºng tÃ´i hiá»ƒu rÃµ hÆ¡n vá»<br>nhu cáº§u cá»§a báº¡n.</p>
                            </div>
                            
                            <div class="contact-content">
                                <div class="contact-info">
                                    <h3 class="info-title">ChÃºng tÃ´i cÃ³ thá»ƒ há»— trá»£ báº¡n:</h3>
                                    <ul class="help-list">
                                        <li>
                                            ...
                                            TÆ° váº¥n vá» gÃ³i data nguá»“n hÃ ng vÃ  dá»‹ch vá»¥ nháº­p kháº©u
                                        </li>
                                        <li>
                                            <span class="check-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" viewBox="0 0 39 39">
                                            ...
                                            Há»— trá»£ khÃ¡ch hÃ ng vÃ  giáº£i Ä‘Ã¡p tháº¯c máº¯c
                                        </li>
                                        <li>
                                            <span class="check-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" viewBox="0 0 39 39">
                                            ...
                                            LiÃªn há»‡ Ä‘á»‘i tÃ¡c vÃ  há»£p tÃ¡c kinh doanh
                                        </li>
                                        <li>
                                            <span class="check-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" viewBox="0 0 39 39">
                                            ...
                                            Giáº£i Ä‘Ã¡p má»i cÃ¢u há»i khÃ¡c báº¡n cÃ³ thá»ƒ cÃ³
                                        </li>
                                    </ul>
                                    <p class="policy-text">Gáº·p váº¥n Ä‘á» khi sá»­ dá»¥ng dá»‹ch vá»¥ ThuongLo? Xem <a href="#">ChÃ­nh sÃ¡ch</a> cá»§a chÃºng tÃ´i Ä‘á»ƒ biáº¿t hÆ°á»›ng dáº«n sá»­ dá»¥ng, cáº­p nháº­t tÃ­nh nÄƒng vÃ  cÃ¡c bÃ i viáº¿t há»— trá»£.</p>
                                </div>
                                    ...
                                    <form class="contact-form-wrapper" method="post" action="<?php echo form_url('contact'); ?>" novalidate>
                                        <div class="form-row">
                                            <div class="form-group">
                                                <input type="text" name="your-name" placeholder="*Há» vÃ  tÃªn" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="your-subject" placeholder="*TiÃªu Ä‘á»" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="your-message" placeholder="*Ná»™i dung tin nháº¯n" class="form-control" rows="10" required></textarea>
                                        </div>
                                        <div class="checkbox-group">
                                            <label class="checkbox-label">
                                                <input type="checkbox" name="your-consent" value="1">
                                                <span class="checkmark"></span>
                                                ÄÄƒng kÃ½ nháº­n thÃ´ng tin khuyáº¿n mÃ£i vÃ  sá»± kiá»‡n má»›i nháº¥t. Báº¡n cÃ³ thá»ƒ há»§y Ä‘Äƒng kÃ½ báº¥t cá»© lÃºc nÃ o.
                                            </label>
                                        </div>
                                        <p class="privacy-text">Báº±ng cÃ¡ch Ä‘iá»n form nÃ y vÃ  nháº¥n gá»­i, báº¡n Ä‘á»“ng Ã½ vá»›i <a href="#">chÃ­nh sÃ¡ch báº£o máº­t</a> cá»§a chÃºng tÃ´i.</p>
                        ...
                        <div class="container">
                            <div class="info-cards">
                                <div class="info-card">
                                    ...
                                    <h3 class="card-title">Äá»‹a chá»‰ vÄƒn phÃ²ng</h3>
                                    <div class="card-content">
                                        Táº§ng 12, TÃ²a nhÃ  ABC, 123 ÄÆ°á»ng Nguyá»…n Huá»‡<br>
                                        Quáº­n 1, TP. Há»“ ChÃ­ Minh<br>
                                        <a href="#" class="view-map">Xem báº£n Ä‘á»“</a>
                                    </div>
                                </div>
                                ...
                                <div class="info-card">
                                    ...
                                    <h3 class="card-title">ThÃ´ng tin liÃªn há»‡</h3>
                                    <div class="card-content">
                                        Äiá»‡n thoáº¡i: (+84) 28 - 3825 - 6789<br>
                                ...
                                <div class="info-card">
                                    ...
                                    <h3 class="card-title">Giá» lÃ m viá»‡c</h3>
                                    <div class="card-content">
                                        Thá»© 2 - Thá»© 6: 08:00 - 18:00<br>
                                        Thá»© 7 & Chá»§ nháº­t: 09:00 - 17:00
                                    </div>
                                </div>
                            </div>
                        </div>
