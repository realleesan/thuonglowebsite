    ...
    <div class="header">
        <div class="container">
            <div class="header-content">
                ...
                <div class="user-info">
                    <span>Xin chÃ o, <?php echo htmlspecialchars($userInfo['full_name']); ?>!</span>
                    <button class="logout-btn" onclick="logout()">ÄÄƒng xuáº¥t</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="container">
            <div class="welcome-card">
                <h1 class="welcome-title">ChÃ o má»«ng Ä‘áº¿n vá»›i Dashboard!</h1>
                <p class="welcome-subtitle">
                    Báº¡n Ä‘Ã£ Ä‘Äƒng nháº­p thÃ nh cÃ´ng vÃ o há»‡ thá»‘ng ThuongLo.com. 
                    ÄÃ¢y lÃ  trang dashboard mÃ´ phá»ng Ä‘á»ƒ test há»‡ thá»‘ng xÃ¡c thá»±c.
                </p>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-card">
                    <h3>ThÃ´ng tin phiÃªn lÃ m viá»‡c</h3>
                    <div class="info-item">
                        <span class="info-label">Thá»i gian Ä‘Äƒng nháº­p:</span>
                    ...
                    <div class="info-item">
                        <span class="info-label">MÃ£ giá»›i thiá»‡u:</span>
                        <span class="info-value"><?php echo htmlspecialchars($_SESSION['referred_by'] ?? 'KhÃ´ng cÃ³'); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card" style="margin-top: 20px;">
                <h3>Log báº£o máº­t (5 hoáº¡t Ä‘á»™ng gáº§n nháº¥t)</h3>
                <?php 
