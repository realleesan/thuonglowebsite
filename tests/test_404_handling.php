    ...
    if (urlParams.get('test') === '404') {
        ...
        testResults.innerHTML = `
            <div style="position: fixed; top: 10px; right: 10px; background: #333; color: white; padding: 15px; border-radius: 5px; z-index: 9999; max-width: 300px;">
                ...
                <p style="margin: 5px 0; font-size: 12px;">✓ 404 page loaded</p>
                <p style="margin: 5px 0; font-size: 12px;">✓ Error content displayed</p>
                <p style="margin: 5px 0; font-size: 12px;">✓ Navigation links available</p>
